            ...
            <div class="contact-card p-5 shadow-lg position-relative" style="background: rgba(255,255,255,0.8); border: 1px solid #d8cab8;">
                ...
                <form action="{{ route('contact.store') }}" method="POST">
                    ...
                    <div class="mb-3 text-start">
                        ...
                        <input type="text" name="role" class="form-control rounded-0" value="{{ old('role') }}" required>
                    </div>

                    <div class="mb-3 text-start">
                        <label class="khula fw-bold small">STAFF TYPE (e.g. Manager / Staff)</label>
                        <input type="text" name="staff_type" class="form-control rounded-0" value="{{ old('staff_type') }}" required>
                    </div>

                    <div class="mb-3 text-start">
                        <label class="khula fw-bold small">PHONE NUMBER</label>
                        <input type="text" name="contact_number" class="form-control rounded-0" value="{{ old('contact_number') }}" required>
                    </div>
