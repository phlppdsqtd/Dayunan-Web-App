            ...
            @forelse ($packages as $package)
                <div class="col-md-6 col-lg-4">
                    <div class="dayunan-card h-100">
                        ...
                        <div class="dayunan-card-body d-flex flex-column">
                            @if(Auth::check() && Auth::user()->role === 'admin')
                            ...
                            @else
                                ...
                                <h3 class="mb-3" style="font-size: 1.4rem; letter-spacing: 0.12rem;">{{ $package->title }}</h3>
